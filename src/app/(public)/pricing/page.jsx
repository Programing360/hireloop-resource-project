...
const faqs = [
  {
    ...
    answer:
      "You can cancel your subscription at any time from your account settings. Once canceled, you will retain access to your plan features until the end of your current billing cycle.",
  },
  {
    question: "Can I get a refund?",
    answer:
      "We offer a 14-day money-back guarantee if you're not satisfied with your plan. Reach out to our support team, and we'll handle it seamlessly.",
  },
  {
    question: "What payment methods do you accept?",
    answer:
      "We accept all major credit cards (Visa, Mastercard, American Express), Google Pay, and Apple Pay through our secure checkout system.",
  },
  {
    question: "Can I switch between plans later?",
    answer:
      "Absolutely. You can upgrade or downgrade your plan instantly. Your remaining balance will be prorated towards the new plan automatically.",
  },
];
    ...
    <div className="min-h-screen bg-[#0D0B14] text-slate-100 py-20 px-4 sm:px-6 lg:px-8 font-sans antialiased selection:bg-purple-500 selection:text-white">
      ...
      <div className="max-w-4xl mx-auto text-center mb-20">
        ...
        <p className="mt-4 text-base sm:text-lg text-slate-400 max-w-xl mx-auto">
          Choose the ideal tier tailored to accelerate your journey, whether you
          are seeking or hiring.
        </p>
                ...
                <ul className="mt-8 space-y-4">
                  {plan.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start">
                      <div
                        className={`flex-shrink-0 p-0.5 rounded-full mt-0.5 ${plan.highlight ? "text-purple-400" : "text-slate-500"}`}
                      >
                        <Check className="h-4 w-4" />
                      </div>
                      <p className="ml-3 text-sm text-slate-400 leading-relaxed">
                        {feature}
                      </p>
                    </li>
                  ))}
      ...
      <div className="max-w-3xl mx-auto mt-36">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Everything you need to know about our plans and billing cycles.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-[#161320] rounded-xl border border-slate-800/60 overflow-hidden shadow-sm"
              >
                <button
