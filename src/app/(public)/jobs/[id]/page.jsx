...
import { 
  ...
  ArrowLeft, Globe, Building2, ShieldCheck, 
...
export default function JobDetailsView({ jobData }) {
  ...
  const job = jobData || {
    ...
    salaryType: "usd",
    deadline: "2026-07-15",
    description: "Build responsive web applications using React and Next.js. Collaborate with cross-functional teams to define, design, and ship new features. Ensure the technical feasibility of UI/UX designs and optimize application for maximum speed and scalability.",
          ...
          <Card className="bg-[#121212] border border-[#262626] rounded-2xl p-6 md:p-8 shadow-2xl">
            <Card.Header className="p-0 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 w-full">
              ...
              <div className="flex items-center gap-5">
                ...
                <div className="space-y-1.5">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <span className={`text-[10px] font-bold tracking-wider px-2.5 py-0.5 rounded-full border uppercase ${statusColors[job.status?.toLowerCase()] || statusColors.pending}`}>
                      {job.status}
                    </span>
                  </div>
              ...
              <Button 
                ...
                className="w-full md:w-auto bg-white text-black hover:bg-gray-200 font-bold px-8 rounded-xl h-12 text-sm shadow-lg shadow-white/5"
              >
                Apply for this job
              </Button>
            </Card.Header>
            ...
            <Card.Content className="p-0 mt-8 pt-6 border-t border-white/[0.04] grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="bg-[#1c1a1a] border border-[#262626] p-4 rounded-xl flex flex-col gap-1">
                <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Salary Range</span>
              ...
              <div className="bg-[#1c1a1a] border border-[#262626] p-4 rounded-xl flex flex-col gap-1">
                <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Job Type</span>
              ...
              <div className="bg-[#1c1a1a] border border-[#262626] p-4 rounded-xl flex flex-col gap-1">
                <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Employees</span>
              ...
              <div className="bg-[#1c1a1a] border border-[#262626] p-4 rounded-xl flex flex-col gap-1">
                <span className="text-[10px] text-gray-500 uppercase tracking-wider font-semibold">Application Deadline</span>
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-2">
            <Card className="bg-[#121212] border border-[#262626] rounded-2xl p-6 md:p-8 h-full">
              <Card.Header className="p-0 mb-4">
                <Card.Title className="text-lg font-bold text-white">Job Description & Responsibilities</Card.Title>
              </Card.Header>
              <Card.Content className="p-0">
                ...
                <h4 className="text-sm font-bold text-white mt-6 mb-3">Requirements:</h4>
                <ul className="list-disc list-inside text-sm text-gray-300 space-y-2 pl-1 font-normal">
                  <li>Proven experience working as a core role in the specified category field.</li>
                  <li>Deep knowledge of modern technical infrastructures and frameworks.</li>
                  <li>Excellent communication and problem-solving capabilities.</li>
                </ul>
              </Card.Content>
            </Card>
          </motion.div>
            ...
            <Card className="bg-[#121212] border border-[#262626] rounded-2xl p-6 flex flex-col justify-between h-full gap-6">
              <div className="space-y-4">
                <Card.Header className="p-0">
                  <Card.Title className="text-base font-bold text-white">About Company</Card.Title>
                </Card.Header>
                
                <Card.Content className="p-0 space-y-4 text-xs">
                  <div className="flex items-center justify-between py-2 border-b border-white/[0.04]">
                    <span className="text-gray-500">Industry Sector</span>
                    <span className="text-white font-semibold capitalize bg-white/5 px-2 py-0.5 rounded-md border border-white/10">{job.category}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between py-2">
                    ...
                    <span className="text-gray-400 font-medium">{formatDate(job.createAt)}</span>
                  </div>
                </Card.Content>
              </div>
